    ...
    ***************************************************************************** */
    ...
    var DrawBoxOptions = /** @class */ (function () {
        function DrawBoxOptions(options) {
            ...
            this.boxColor = boxColor || 'rgba(251, 188, 159, 0.7)';
        ...
        faceExpressionsArray.forEach(function (e) {
            ...
            var drawTextField = new DrawTextField(resultsToDisplay.map(function (expr) {
                ...
                switch(expr.expression){
                    case "neutral":
                        expr.expression="naturale";
                        break;
                    case "happy":
                        expr.expression="felice";
                        break;
                    
                    case "disgusted":
                        expr.expression="disgustato";
                        break; 
                    case "surprised":
                        expr.expression="sorpreso";
                        break; 
                    case "sad":
                        expr.expression="triste";
                        break; 
                    case "angry":
                        expr.expression="arrabbiato";
                        break;    
                }
